...
class News(models.Model):
    ...
    creator = models.ForeignKey('UserProfile', verbose_name='創建者', blank=True, related_name='+',
    ...
    userprofile = models.ManyToManyField('UserProfile', verbose_name='用戶', blank=True)
...
class UserProfile(models.Model):
    ...
    dent = models.ForeignKey('Department', verbose_name='部門', blank=True, on_delete=models.CASCADE)
...
class Department(models.Model):
    ...
    user = models.ForeignKey('UserProfile', verbose_name='部門負責人', blank=True, on_delete=models.CASCADE)
...
class Asset(models.Model):
    ...
    department = models.ForeignKey('Department', verbose_name='部門', null=True, on_delete=models.CASCADE)
    ...
    latest_user = models.ForeignKey("UserProfile", verbose_name='更新者', blank=True, related_name='+',
                                    on_delete=models.CASCADE)
...
class AssetToAssets(models.Model):
    ...
    資產關聯資產
    '''
    asset_obj = models.ForeignKey('Asset', verbose_name="資產編號", related_name='+', on_delete=models.CASCADE)
    assets = models.ForeignKey("Asset", verbose_name='關聯資產', related_name='+', on_delete=models.CASCADE)
...
class AssetRecord(models.Model):
    ...
    creator = models.ForeignKey('UserProfile', verbose_name='創建者', null=True, blank=True, related_name='creator',on_delete=models.CASCADE)
...
class AssetRepair(models.Model):
    ...
    asset_obj = models.ForeignKey('Asset', verbose_name='資產編號',on_delete=models.CASCADE)
    title = models.CharField(max_length=255, verbose_name='標題')
    summary = models.TextField(verbose_name='內文', null=True, blank=True)

    creator = models.ForeignKey('UserProfile', verbose_name='創建者', null=True, blank=True, related_name='+',on_delete=models.CASCADE)

    # 狀態: 處理完成 或 需跟進
    status = models.BooleanField(default=False)

    # 維修者：最後是誰修理完成的
    repairer = models.ForeignKey('UserProfile', verbose_name='維修者', null=True, blank=True, related_name='+',on_delete=models.CASCADE)

    # 檔案: 圖片 多對多
    photo = models.ManyToManyField('AssetRepairImage', blank=True)
...
class AssetRepairDetail(models.Model):
    ...
    repair = models.ForeignKey('AssetRepair',on_delete=models.CASCADE)
...
class BusinessUnit(models.Model):
    ...
    dent = models.ForeignKey(Department, verbose_name='部門',on_delete=models.CASCADE)
...
class AssetBusiness(models.Model):
    ...
    asset = models.OneToOneField("Asset", verbose_name='資產',on_delete=models.CASCADE)
    business = models.ForeignKey("BusinessUnit", verbose_name='業務線', blank=True, null=True,on_delete=models.CASCADE)
